...
public class IndividualInsert extends JFrame {
    private JPanel root;
    ...
    IndividualInsert(Statement stm) {
            ...
            try {
                ...
                if (choice == 0) {
                    ...
                    if (flag == 0) {
                        ...
                        stm.executeUpdate(x);
                        x = "insert into Individual values(" + phone_no + ", '" + fname + "' ,'" + lname + "' ,'" + category + "')";
                        stm.executeUpdate(x);
                    } else {
